...
<div class="container">
      ...
      <div class="row my-4">
        <div class="col-lg-8">
          <img class="img-fluid rounded" src="Images/anete-lusina-382329-unsplash.jpg" alt="">
        </div>
        <!-- /.col-lg-8 -->
        <div class="col-lg-4">
      ...
      <div class="row">
        <div class="col-md-4 mb-4">
            <img class="img-fluid rounded" src="Images/ben-o-bro-170472-unsplash.jpg" />
          <div class="card">
              <div class="card-body">
              <h2 class="card-title">7 Project Managment Tricks and Tips</h2>
             </div>
        ...
        <!-- /.col-md-4 -->
        <div class="col-md-4 mb-4">
            <img class="img-fluid rounded" src="Images/william-iven-22449-unsplash.jpg" />
          <div class="card">
            <div class="card-body">
              <h2 class="card-title">How to keep you Project Organize</h2>
              </div>
            <div class="card-footer">
              <a href="#" class="btn btn-primary">More Info</a>
            </div>
        ...
        <!-- /.col-md-4 -->
        <div class="col-md-4 mb-4">
            <img class="img-fluid rounded" src="Images/nikolay-tarashchenko-551722-unsplash.jpg" />
          <div class="card">
            <div class="card-body">
              <h2 class="card-title">Update your project on any device</h2>
              </div>
            <div class="card-footer">
              <a href="#" class="btn btn-primary">More Info</a>
            </div>
    ...
    <footer class="py-5 bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; GROUP 1 2018</p>
      </div>
      <!-- /.container -->
    </footer>
