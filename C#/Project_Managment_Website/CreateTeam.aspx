...
<head runat="server">
    <title>Project Management - Create Team</title>
...
<body>
    ...
    <form class ="createTeam" id="form1" runat="server">
        <div class="container">
            <h1>Create Team</h1>
            ...
            <br />
            <asp:Label class="sr-only" ID="Label3" runat="server" Text="Team Lead"></asp:Label>        
            <asp:TextBox class="form-control" placeholder ="Teamlead ID: " ID="teamLeadID" runat="server" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
